...
// using the ISO 8601 compliant/mysql format: YYYY-MM-DD hh:mm:ss and
// internally stores the data as
...
// maybe provide some inspirtation, don't know where to put this right now.
//#include <iostream>
